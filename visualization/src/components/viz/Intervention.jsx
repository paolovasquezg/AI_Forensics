    ...
    <div className="space-y-5">
      ...
      <div ref={wrapRef} className="bg-slate-900/60 rounded-lg border border-slate-700 p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="text-sm font-semibold text-slate-300">Top 10 Candidate Edges</div>
        ...
        <div className="text-xs text-slate-500 mt-2">
          Bar length = total anomalous uses · Colored by incident · Click a row to inspect
        </div>
      </div>
      ...
      {detail && (
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-4 space-y-3">
          ...
          <p className="text-xs text-slate-400 border-t border-slate-700 pt-3">
            ...
            {detail.in_all_incidents
              ? 'It appears in all 3 incidents — the single highest-leverage intervention point in the system.'
              : `It appears in ${detail.incidents_count} of 3 incidents.`
            }
          </p>
        </div>
      )}
